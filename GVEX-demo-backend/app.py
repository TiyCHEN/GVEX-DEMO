...
from GVEX import approximate_algorithm
import torch
...
def get_dataset():
    if request.method == 'POST':
        ...
        return approximate_algorithm.get_dataset_info(dataset_name)
...
def get_baselines():
    if request.method == 'POST':
        ...
        return approximate_algorithm.get_baselines(algorithm_name['algorithm_name'])